...
// Lazy-load every page — cuts initial JS bundle by ~50%
...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      staleTime: 1000 * 60 * 2,   // cache data for 2 min before refetching
      gcTime: 1000 * 60 * 10,     // keep unused data in memory for 10 min
      retry: 1,
    },
  },
});

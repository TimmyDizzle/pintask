    ...
    <MarketingLayout>
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-3xl">
          <h1 className="font-heading text-4xl font-extrabold tracking-tight sm:text-5xl text-center">
            About Pintask
          </h1>
          <div className="mt-12 space-y-6 text-muted-foreground leading-relaxed">
            ...
            <h2 className="font-heading text-2xl font-bold text-foreground pt-4">Our principles</h2>

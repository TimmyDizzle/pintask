...
const extensions = [
  {
    ...
    desc: "Add tasks from any webpage. Clip content, save links, and manage your board without leaving your browser.",
    status: "Coming Soon",
  },
  {
    icon: Globe,
    title: "Firefox Add-on",
    desc: "Full Pintask integration for Firefox users. Same great features, same fast workflow.",
    status: "Coming Soon",
  },
  {
    icon: Smartphone,
    title: "Mobile App (PWA)",
    desc: "Install Pintask on your phone as a progressive web app. Works offline, syncs when you're back online.",
    ...
    <MarketingLayout>
      ...
      <section className="border-t border-border/40 bg-muted/30 px-6 py-20">
        <div className="mx-auto max-w-4xl grid gap-8 md:grid-cols-3">
          {extensions.map((ext) => (
            <div key={ext.title} className="rounded-xl border border-border/50 bg-card p-6 shadow-sm text-center">

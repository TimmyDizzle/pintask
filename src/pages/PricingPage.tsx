...
const plans = [
  {
    name: "Personal", price: "Free", period: "",
    ...
    <MarketingLayout>
      ...
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-6xl grid gap-8 md:grid-cols-3">
          {plans.map((plan, i) => (
            <RevealSection key={plan.name} delay={100 + i * 120}>
              <div
                className={`flex flex-col rounded-xl border-2 p-8 shadow-sm h-full ${
                  plan.highlight
              ...
              >
                ...
                <div className="mt-8">
                  <Button size="lg" className="w-full" variant={plan.highlight ? "secondary" : "default"} asChild>
